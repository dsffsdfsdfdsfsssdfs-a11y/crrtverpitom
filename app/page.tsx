...
export default function Home() {
  ...
  return <main style={fontStyles}>
    <header className="topbar">
      <a className="brand" href="#top">{c.header.logoImage?<img className="brand-image" style={{width:c.header.logoSize,height:c.header.logoSize,transform:`translate(${c.header.logoX}px,${c.header.logoY}px)`}} src={c.header.logoImage} alt="Логотип"/>:<span className="brand-mark">ЦР</span>}<span style={{fontSize:`${c.header.textSize}%`,transform:`translate(${c.header.textX}px,${c.header.textY}px)`}}>{c.header.title}<br/><b>{c.header.subtitle}</b></span></a>
