...
export default function Home() {
  ...
  return <main style={fontStyles}>
    <header className="topbar">
      <a className="brand" href="#top">{c.header.logoImage?<img className="brand-image" src={c.header.logoImage} alt="Логотип"/>:<span className="brand-mark">ЦР</span>}<span>{c.header.title}<br/><b>{c.header.subtitle}</b></span></a>
    ...
    <section className="hero" id="top" style={{backgroundImage:`linear-gradient(90deg,#1b120ddd,#1b120d33),url(${c.hero.image})`}}>
